...
int circuit_id_in_use_on_chan(circid_t circ_id, channel_t *chan);
...
void circuit_get_all_pending_on_chan(smartlist_t *out,
                                     channel_t *chan);
int circuit_count_pending_on_chan(channel_t *chan);
